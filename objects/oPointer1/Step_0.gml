...
if (place_meeting(x, y, oElementRed) && keyboard_check_pressed(vk_escape)) {
...
if (place_meeting(x, y, oElementYellow) && keyboard_check_pressed(vk_escape)) {
...
if (place_meeting(x, y, oElementGreen) && keyboard_check_pressed(vk_escape)) {
